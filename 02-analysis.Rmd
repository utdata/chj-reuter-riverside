...
It's likely that we'll change the data shape of the above data as well. For instance, it is not tidy to have separate colunns for the test result. There should be one column with the value of that result.
